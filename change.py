            ...
            if st.button("Evaluate"):
                if len(user_input) < 20:
                    ...
                    prompt = f"""
                            ...
                            and under the **evaluation based on sop** the evaluation should be like the following two list list "[[criteria_from_sop],[evaluation_mark],[reason_for_the_evaluation]]"
